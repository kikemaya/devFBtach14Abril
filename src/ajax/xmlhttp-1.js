...
function getData(url, callback) {
  ...
  xhttp.onreadystatechange = () => {
    ...
    if (xhttp.readyState === 4) {
      //8.una vez la que la respuesta ya se proceso, la respuesta me va a dar un status 100,200,300,400  200 = ok
      ...
      if (xhttp.status === 200) {
        ...
        //y que la respuesta que regresen la pases aún JSON.
